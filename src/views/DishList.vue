...
<br>
    <el-tabs type="border-card">
       <el-tab-pane v-for="(c,i) in dishList" :key="i" class="">
          <span slot="label">
            <el-badge :value="c.dishList.length">{{c.cname}}</el-badge>
          </span>

          <el-row>
            <el-col v-for="(d,j) in c.dishList" :xs="12" :md="6" :lg="4" :xl="3">
               <!--<xfn-dish :data="d"><xfn-dish>-->
               {{d.title}}
               <img :src="require('../assets/img/dish/'+d.imgUrl)" style="max-width:90%">
            </el-col>
          </el-row>
       </el-tab-pane>
    </el-tabs>
